// FAQ
export const TUT_FAQ_TOUR = [
    {
        target: ".main-heading",
        placement: "bottom-end",
        title: "A Tour of Everything",
        content: "The entire interface may seem daunting at first, but fear not...",
        disableBeacon: true,
    },
    {
        ...
        content: "This is the preview channel",
    },
    {
        target: ".obs-canvas",
        placement: "bottom-end",
        title: "Live Stream",
        content: "This will be seen by everyone in the livestream",
    },
    {
        target: ".cam1-images",
        title: "Camera 1 Image",
        content: "Click to choose an image for Camera 1",
    },
    {
        target: ".cam2-images",
        title: "Camera 2 Image",
        content: "Click to choose an image for Camera 2",
    },
    {
        target: ".presenter-slides",
        title: "Presenter Slide",
        content: "Click to choose a Powerpoint slide or video image",
    },
    {
        target: ".macros-menu",
        title: "Macros",
        content: "Select and run a macro",
    },
    {
        target: ".atem-pip-enable",
        title: "PiP",
        content: "Manually enable/disable Picture-in-Picture (PiP) mode",
    },
    {
        target: ".pip-controls",
        placement: "bottom-end",
        title: "PiP Controls",
        content: "Use the arrows or other buttons to hide or change the PiP position",
    },
    {
        target: ".atem-chroma-key-enable",
        placement: "top-start",
        title: "Chroma Key",
        content: "The chroma key is responsible for the green screen effect",
    },
    {
        target: ".atem-mic1",
        title: "Mic 1",
        content: "Control Mic 1 volume here or enable/disable it",
    },
    {
        target: ".atem-chan1",
        title: "Channel 1",
        content: "Click this to preview Camera 1",
    },
    {
        target: ".atem-chan3",
        title: "Channel 3",
        content: "Click this to preview the presenter",
    },
    {
        target: ".atem-micChan3",
        title: "Channel 3 Audio",
        content: "Control the presenter audio volume here or enable/disable it",
    },
    {
        target: ".atem-chan4",
        title: "Channel 4",
        content: "Click this to preview Camera 2",
    },
    {
        target: ".atem-auto",
        title: "Auto",
        content: "Press Auto to switch/interchange between live and preview channels",
    },
];
